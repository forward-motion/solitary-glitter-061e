...
```
npm create cloudflare@latest -- --template=cloudflare/templates/solitary-glitter-061e
```

## Preview Deployment

A live public deployment of this template is available at [https://solitary-glitter-061e.templates.workers.dev](https://solitary-glitter-061e.templates.workers.dev)
